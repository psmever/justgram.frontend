...
export { default as TestComponent } from './element/TestComponent';

export { default as FooterComponent } from './element/common/FooterComponent';
export { default as DefaultNavComponent } from './element/common/DefaultNavComponent';
